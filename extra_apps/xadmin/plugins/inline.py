...
class InlineFormsetPlugin(BaseAdminPlugin):
    ...
    def inline_instances(self):
        if not hasattr(self, '_inline_instances'):
            ...
            # isinstance(inline, BorrowerInlines)
            # print(inline_instances, '----------------')
            # print(self.model.objects , '----------------')
            # print(self.model.objects.last(), 'A---A')
            # print(hasattr(self, '_inline_instances'), 'current----------')
            # print(getattr(self.model.objects.first(), 'is_borrower'))
